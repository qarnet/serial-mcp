...
## Dual MCP lifecycle and subscriptions
...
- Modern stateless HTTP requests additionally require SEP-2243
  ...
  (`ttlMs`/`cacheScope`) is covered in the cache compliance section below.
