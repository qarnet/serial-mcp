...
| [code-cleanup-plan.md](code-cleanup-plan.md) | Active behavior-preserving cleanup plan: shared TX transformations, RX readability, profile construction, and cross-platform test-harness consolidation. |
