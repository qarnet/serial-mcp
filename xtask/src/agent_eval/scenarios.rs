...
pub fn scenarios() -> Vec<Scenario> {
    ...
    vec![
        ...
        Scenario {
            ...
            modeled: None,
            completion_ref: "tests/device_framing_parity.rs::line_framing_returns_exact_ordered_peer_frames",
            stale_race: false,
            retries: 0,
            invalid_calls: 0,
            common: true,
        ...
        Scenario {
            ...
            modeled: None,
            completion_ref: "tests/device_fixture.rs::public_mcp_ping_hold_disconnect_replace_and_reconnect",
            stale_race: false,
            retries: 1,
            invalid_calls: 0,
            common: false,
